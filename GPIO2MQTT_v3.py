...
def on_connect(client, userdata, flags, rc):
	...
	client.subscribe([(host.studentTopic,0),(host.stationTopic,0),(host.statusTopic,0),(host.mailingTopic,0)])
...
if __name__ == '__main__':
	...
	GPIO.setup(38,GPIO.OUT)				# Configurate pin 38 as a Dispatching ULD Cargo pin (Node-RED)
	statusPin16 = GPIO.output(16,0)		# Pin16 (GPIO23) status (sensor)
	statusPin18 = GPIO.output(18,0)		# Pin16 (GPIO23) status (sensor)
